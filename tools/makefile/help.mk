help:
	...
	@printf "  make solve_seq SOLVE_SEQ_REPEATS=3 SOLVE_SEQ_RUNTIME_S=300 SOLVE_SEQ_STAGNATION_EPOCHS=80 SOLVE_SEQ_MIN_REL_IMPROVEMENT=10\n"
	@printf "  make solve_mpi SOLVE_MPI_REPEATS=3 SOLVE_MPI_RUNTIME_S=300 SOLVE_MPI_STAGNATION_EPOCHS=80 SOLVE_MPI_MIN_REL_IMPROVEMENT=10 SOLVE_MPI_RANKS=$${SLURM_NTASKS:-4} SOLVE_MPI_OMP_THREADS=$${SLURM_CPUS_PER_TASK:-8}\n"
