...
ACO_CONFIG_OBJ=$(COMMON_DIR)/aco_config.o
...
SOLVE_CUDA_RUNTIME_S?=300
SOLVE_CUDA_STAGNATION_EPOCHS?=0
SOLVE_CUDA_MIN_REL_IMPROVEMENT?=0.1
SOLVE_MEMORY_GROWTH_REPEATS?=3
SOLVE_MEMORY_GROWTH_CLIENTS?=4000,8000,16000,32000,64000
...
EXP_MAX_CPUS_PER_TASK?=32
EXP_MAX_TOTAL_CORES?=128
EXP_WEAK_BASE_N_PER_WORKER?=1000
EXP_MPI_LAUNCHER?=mpirun

EXP_STRONG_OPENMP_N?=16000
EXP_STRONG_OPENMP_THREADS?=1 2 4 8 16 32
EXP_WEAK_OPENMP_PAIRS?=auto

EXP_STRONG_MPI_N?=16000
EXP_STRONG_MPI_RANKS?=1 2 4
EXP_STRONG_MPI_OMP_THREADS?=32
EXP_STRONG_HYBRID_N?=16000
EXP_STRONG_HYBRID_PAIRS?=1 1 1 2 1 4 1 8 1 16 1 32 2 32 4 32

EXP_WEAK_MPI_PAIRS?=1 1000 2 2000 4 4000
EXP_WEAK_MPI_OMP_THREADS?=32
EXP_WEAK_HYBRID_TRIPLETS?=1 32 1000 2 32 2000 4 32 4000

# CUDA experiments defaults
EXP_CUDA_CLIENTS_FUNCTIONAL?=500,1000,2000,4000,8000,16000,32000,64000
EXP_CUDA_M_LIST?=64 128 256
EXP_CUDA_SCALING_M_FIXED?=256
EXP_CUDA_SCALING_CLIENTS?=500,1000,2000,4000,8000,16000,32000,64000
EXP_CUDA_REPEATS?=1
...
GEN_CLIENTS?=500,1000,2000,4000,8000,16000,32000,64000
GEN_SEED_BASE?=19000
GEN_GRID?=100
