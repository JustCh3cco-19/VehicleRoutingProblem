...
# Requested campaign presets (user-defined scaling matrix)
REQ_CLIENTS_SERIES?=2000,4000,8000,16000,32000,64000
REQ_OPENMP_THREADS?=1 4 8 16 32
REQ_MPI_STRONG_RANKS?=1 2 4
REQ_MPI_STRONG_OMP_THREADS?=32
REQ_HYBRID_CORE_TARGETS?=8 16 32 64 128
REQ_HYBRID_RANKS?=1 2 4
REQ_SEQ_CUDA_CLIENTS?=$(REQ_CLIENTS_SERIES)
REQ_REPEATS?=1
