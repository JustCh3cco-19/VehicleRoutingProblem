...
SEQ_SRC=$(SEQ_DIR)/sequential.c $(SEQ_DIR)/candidates.c $(SEQ_DIR)/candidates_avx.c $(SEQ_DIR)/tour.c $(SEQ_DIR)/tour_select.c $(SEQ_DIR)/tour_select_large.c $(SEQ_DIR)/workspace.c $(SEQ_DIR)/math_utils.c $(SEQ_DIR)/mem_utils.c $(SEQ_DIR)/seq_ctx.c $(SEQ_DIR)/seq_ant.c $(SEQ_DIR)/seq_epoch.c $(SEQ_DIR)/seq_pheromone.c
...
ACO_SHARED_SRC=$(COMMON_DIR)/shared.c $(COMMON_DIR)/shared_select.c $(COMMON_DIR)/shared_solver.c $(COMMON_DIR)/score_cache.c $(COMMON_DIR)/score_cache_lifecycle.c
ACO_CONFIG_SRC=$(COMMON_DIR)/config.c
SOLUTION_SRC=$(COMMON_DIR)/solution.c $(COMMON_DIR)/solution_cost.c $(COMMON_DIR)/solution_validate.c $(COMMON_DIR)/solution_validate_cvrp.c
MATRIX_SRC=$(COMMON_DIR)/matrix.c
INSTANCE_PARSER_SRC=$(COMMON_DIR)/instance_parser.c
CLI_COMMON_SRC=$(COMMON_DIR)/cli_common.c
SEQ_OBJ=$(SEQ_DIR)/sequential.o $(SEQ_DIR)/candidates.o $(SEQ_DIR)/candidates_avx.o $(SEQ_DIR)/tour.o $(SEQ_DIR)/tour_select.o $(SEQ_DIR)/tour_select_large.o $(SEQ_DIR)/workspace.o $(SEQ_DIR)/math_utils.o $(SEQ_DIR)/mem_utils.o $(SEQ_DIR)/seq_ctx.o $(SEQ_DIR)/seq_ant.o $(SEQ_DIR)/seq_epoch.o $(SEQ_DIR)/seq_pheromone.o
ACO_SHARED_OBJ=$(COMMON_DIR)/shared.o $(COMMON_DIR)/shared_select.o $(COMMON_DIR)/shared_solver.o $(COMMON_DIR)/score_cache.o $(COMMON_DIR)/score_cache_lifecycle.o
ACO_CONFIG_OBJ=$(COMMON_DIR)/config.o
SOLUTION_OBJ=$(COMMON_DIR)/solution.o $(COMMON_DIR)/solution_cost.o $(COMMON_DIR)/solution_validate.o $(COMMON_DIR)/solution_validate_cvrp.o
...
CUDA_ACO_SRC=src/cuda/cuda.cu src/cuda/cuda_utils.cu src/cuda/cuda_setup.cu src/cuda/cuda_device.cu src/cuda/cuda_solution.cu src/cuda/cuda_stats.cu
CUDA_KERNELS_SRC=src/cuda/kernels.cu src/cuda/kernels_launch.cu
CUDA_MAIN_OBJ=src/main_cuda.o
CUDA_ACO_OBJ=src/cuda/cuda.o src/cuda/cuda_utils.o src/cuda/cuda_setup.o src/cuda/cuda_device.o src/cuda/cuda_solution.o src/cuda/cuda_stats.o
CUDA_KERNELS_OBJ=src/cuda/kernels.o src/cuda/kernels_launch.o
