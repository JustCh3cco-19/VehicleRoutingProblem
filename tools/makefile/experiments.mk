...
exp_cuda_scaling_input:
	...
	$(MAKE) solve_cuda \
		...
		SOLVE_CUDA_M="$(EXP_CUDA_SCALING_M_FIXED)" \
...
exp_cuda_scaling_ants:
	...
	@for m in $(EXP_CUDA_M_LIST); do \
		...
		$(MAKE) solve_cuda \
			SOLVE_CSV_DIR="$(RESULTS_ROOT)/solve_manifest/csv/exp_cuda_scaling_ants/m$$m" \
			SOLVE_SOLUTIONS_DIR="$(RESULTS_ROOT)/solve_manifest/solutions/exp_cuda_scaling_ants/m$$m" \
