...
solve_mpi: solve_prepare
	...
	SOLVE_MPI_M="$(SOLVE_MPI_M)" \
	SOLVE_MPI_FIXED_EPOCHS="$(SOLVE_MPI_FIXED_EPOCHS)" \
...
solve_memory_growth_non_cuda:
	@$(MAKE) solve_seq SOLVE_CLIENTS="$(if $(SOLVE_CLIENTS),$(SOLVE_CLIENTS),$(SOLVE_MEMORY_GROWTH_CLIENTS))" SOLVE_SEQ_REPEATS="$(SOLVE_MEMORY_GROWTH_REPEATS)"
	@$(MAKE) solve_mpi SOLVE_CLIENTS="$(if $(SOLVE_CLIENTS),$(SOLVE_CLIENTS),$(SOLVE_MEMORY_GROWTH_CLIENTS))" SOLVE_MPI_REPEATS="$(SOLVE_MEMORY_GROWTH_REPEATS)"
