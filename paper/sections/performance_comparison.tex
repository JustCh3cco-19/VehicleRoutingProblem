...
\begin{figure*}[t]
\centering
\includegraphics[width=0.32\textwidth]{figures/strong_scaling_runtime.pdf}\hfill
\includegraphics[width=0.32\textwidth]{figures/strong_scaling_speedup.pdf}\hfill
\includegraphics[width=0.32\textwidth]{figures/strong_scaling_efficiency.pdf}
...
The weak campaign fixes $n=8{,}000$ and 100 epochs while maintaining 32 ants per total CPU worker.  OpenMP covers 1--32 workers on one rank; MPI extends the curve to 64 and 128 workers with 32 threads per rank.  The population therefore grows from 32 to 4096 and the workload-per-worker relation is constant.  We report $E^{weak}_p=T_1/T_p$ and use the OpenMP point at 32 workers in the combined curve.  The independent one-rank MPI measurement at the same point is retained as a consistency check.

\begin{figure*}[t]
\centering
\includegraphics[width=0.48\textwidth]{figures/weak_scaling_runtime.pdf}\hfill
\includegraphics[width=0.48\textwidth]{figures/weak_scaling_efficiency.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/backend_runtime.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figures/backend_cost.pdf}
