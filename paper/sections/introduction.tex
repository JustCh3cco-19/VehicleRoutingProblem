...
I study the \textbf{Constrained Vehicle Routing Problem} (CVRP) solved through \textbf{Ant Colony Optimization} (ACO), focusing on the implementation choices needed for shared-memory, distributed-memory, and GPU execution.
