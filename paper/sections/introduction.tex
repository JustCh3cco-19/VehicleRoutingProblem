...
We study a \textbf{capacitated vehicle routing problem} solved through \textbf{Ant Colony Optimization} (ACO), focusing on the implementation choices needed for shared-memory, distributed-memory, and GPU execution.
