...
written below paper/generated/ and paper/figures/.
"""
...
def write_report(
    ...
    lines = [
        ...
        "",
        "Generated by `python3 paper/scripts/analyze_results.py`. Raw files under `results/` were not modified.",
        "",
        "## Coverage",
        "",
...
def main() -> int:
    ...
    parser.add_argument("--data-dir", type=Path, default=Path("paper/generated"))
